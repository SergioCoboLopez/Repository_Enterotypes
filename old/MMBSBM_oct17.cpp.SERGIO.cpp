...
int main(int argc, char *argv[])
{
  ...
  //----------------------------------------------
  // mat theta_raw(People,Groups_People,fill::zeros);
  // Update_Matrices.theta=zeros(People,K);
  //----------------------------------------------
  //eta
  //----------------------------------------------
  // mat eta_raw(Groups_Microbes,Microbes,fill::zeros);
  // Update_Matrices.eta=zeros(MBiome,L);
  //----------------------------------------------
  //pkl
  //----------------------------------------------
  // Update_Matrices.P=zeros(K,L,Links);
  //----------------------------------------------
  ...
  //1.5. Bucle de Expectation-Maximization
  //=============================================================================================================

  //1.5.1. Declaracion de variables
  //-----------------------------------------------------------------------------------
  field<mat> Omega(K,L);
  //Pruebas!!
  //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  for (int Iterations=0;Iterations<Limit;Iterations++){
    ...
    //Nuevas funciones
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    Omega=GetOmegaMarch(People,K,MBiome,L,Links,Update_Matrices,Data,ListAbund,number_of_links,Omega);
