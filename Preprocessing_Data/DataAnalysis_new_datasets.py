...
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ 
path='../../Input_Data/Datasets_Diseases/raw/'

Datasets_Healthy=['He_Healthy','Nielsen_Healthy','Vogtmann_Healthy','Zeller_Healthy','Zhang_Healthy']
Datasets_Diseased=['He_CD','Nielsen_IBD','Vogtmann_CRC','Zeller_CRC','Zhang_RA']


State='Healthy'  #Healthy, Diseased
if State=='Healthy':
    Datasets=Datasets_Healthy
elif State=='Diseased':
    Datasets=Datasets_Diseased
...
plt.savefig("../../Plots/Second_Path/Datasets_" + State + ".pdf")
plt.show()
