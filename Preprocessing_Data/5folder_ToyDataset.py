...
#==================================================================
d1=0.01*(pd.read_csv('../../Input_Data/toy_data.txt', sep='\t', header=None))
#Subset=d1[ [column for column in range(10)] ][0:10]
NumpySubset = d1.as_matrix()
print NumpySubset
print NumpySubset.max()
global rows;   rows=NumpySubset.shape[0]
global columns;columns=NumpySubset.shape[1]
#==================================================================
...
#1.5. Generate Train+Test
#===============================================================
path='/export/home/shared/Projects/Microbiome/Input_Data/5Fold_ToyData_TestFolder/'
