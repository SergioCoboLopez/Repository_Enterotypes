...
#1. De las distribuciones de entropias de Shannon de personas y microbios
...
#Aparte de eso, naturalmente, el codigo calcula entropias de Shannon y segrega
#usuarios y microbios por niveles de entropia de shannon
...
#=====================================================
def get_name(Seed,Fold):
        Name_of_File='Dataset_Fold_' + str(Fold) + '_Seed_' + str(Seed) \
            + '_Parameters.txt'
        return Name_of_File
#=====================================================
...
{'S-8_Tot':107,'V-10_Tot':92,'V-22_Tot':467,'V-23_24_Tot':222,'V-25_Tot':883,\
 'S-8_s1':107, 'V-10_s1':92, 'V-22_s1':467, 'V-23_24_s1':222, 'V-25_s1':883,\
 'S-8_s2':107, 'V-10_s2':92, 'V-22_s2':467, 'V-23_24_s2':222, 'V-25_s2':883}

Microbes_per_Dataset=\
{'S-8_Tot':128,'V-10_Tot':137,'V-22_Tot':134,'V-23_24_Tot':118,'V-25_Tot':144,\
 'S-8_s1':211, 'V-10_s1':208, 'V-22_s1':269, 'V-23_24_s1':227, 'V-25_s1':291,\
 'S-8_s2':128, 'V-10_s2':137, 'V-22_s2':134, 'V-23_24_s2':118, 'V-25_s2':144}
 

Patients=Patients_per_Dataset[Dataset];#Microbes=313;
...
for Seed in range(1,10,2):
    ...
    LikelihoodFinal=read_file(path + Likelihood_File)[-1]
...
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
print sum(Patients[0])
Plots=['ShannonEntropy', 'theta+eta_Occupation', 'Heatmaps_Patients',
'Heatmaps_Microbes','Heatmap_Microbes_with_Metadata','nothing']
Information=Plots[2]
...
if Information==Plots[0]:
    ...
    sns.distplot(EntropyMicrobes,bins=K, kde=False, norm_hist=True, color=color)
    #Lineas verticales
    #-----------------------------------------------
    ...
    #===================================================
    path_out='../../Plots/First_Path/' 
    plt.savefig(path_out + Dataset + '_Shannon_MMSBM.pdf',dpi=300)
    plt.show()
    #++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    #++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    path_out='../../Plots/First_Path/' 
    plt.savefig(path_out + Dataset + '_theta+eta_Occupation.pdf',dpi=300)
    plt.show()
#==============================================================================
    ...
    gs.update(left=0.032, right=0.95, wspace=0.25,hspace=0.01, bottom=0.08, top=0.96)
...
#        ax0.set(xticklabels=New_Order_Cols_Patients[plot])
        ...
        sns.heatmap(Heatmap,cmap="RdBu_r",vmin=0,vmax=1,cbar=False,xticklabels=New_Order_Cols_Patients[plot],yticklabels=False)
    ...
    path_out='../../Plots/First_Path/' 
    plt.savefig(path_out + Dataset + '_Patients_Heatmap.pdf',dpi=300)
    plt.show()
#==============================================================================
...
#==============================================================================
    ...
    fig=plt.figure(figsize=(6*(columnas),10))
    ...
    gs = gridspec.GridSpec(2, columnas+1, width_ratios=Ancho_Plots, height_ratios=[0.2,0.8]   )
    gs.update(left=0.024, right=0.94, wspace=0.26,hspace=0.01, bottom=0.07, top=0.96)
...
#        ax0.set(xticklabels=New_Order_Cols_Microbes[plot])
        ...
        sns.heatmap(Heatmap,cmap="RdBu_r",cbar=False,vmin=0,vmax=1,xticklabels=False, yticklabels=False)
        ...
        xtick_pos= [n+0.5 for n in range(0,L)]
        ax.set_xticks( xtick_pos )
        ax.set_xticklabels(New_Order_Cols_Microbes[plot],fontsize=11)
    ...
    path_out='../../Plots/First_Path/' 
    plt.savefig(path_out + Dataset + '_Microbes_Heatmap.pdf',dpi=300)
    plt.show()
#==============================================================================
