...
def Joint_Plot(X,Y,Z,Frame,Ylabel,size_eje,Correlations,counter_plot,colors_shapes,letter,Microbes=False):
    #::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    Scatter1=plt.subplot(Frame[1, 0])
    sns.despine(offset=0,ax=Scatter1,top=True,right=True,left=False,bottom=False)
    counter=0
    for x,y,z in zip(X,Y,Z):
        
        if Microbes==1:
            plt.scatter(x,y,color=colors_shapes[z][0],\
                        marker=colors_shapes[z][1],s=5)
        else:
            plt.scatter(x,y,color=colors_shapes[z],s=5)
            
        counter+=1

    plt.xlim(-0.05,0.8)
    ticks_posx=[0,0.4,0.8]
    Scatter1.set_xticks(ticks_posx)
    Scatter1.set_xticklabels(ticks_posx,fontsize=size_ticks)
    
    plt.ylim(-0.05,1.1)
#    if counter_plot==2:
    if counter_plot==0:
        plt.ylim(0.495,1.1)
        ticks_posy=[0.5,0.75,1]
        Scatter1.set_yticks(ticks_posy)
        Scatter1.set_yticklabels(ticks_posy,fontsize=size_ticks)
    else:
        ticks_posy=[0,0.25,0.5,0.75,1]
        Scatter1.set_yticks(ticks_posy)
        Scatter1.set_yticklabels(ticks_posy,fontsize=size_ticks)
    ...
    if Microbes==0:
        plt.ylabel(Metric2Plot,fontsize=size_eje)
    ...
    if counter_plot==2:
        ...
        if Microbes==1:
            ...
            plt.xlabel(r'$H_{hosts}$',fontsize=size_eje)

    #Legend
    #------------------------------------------------
    legend_x_1=min(X)
    legend_y_1=1.1*abs(Lim_y_up[0])

    Num_Corrected='{:0.3e}'.format(Correlations[1])
    Scatter1.text(legend_x_1, legend_y_1, \
    'p-value: %s' %str(Num_Corrected),fontsize=8,style='normal')
    #------------------------------------------------
    ...
    #::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    if counter_plot==0:
        Hist_x=plt.subplot(Frame[0, 0])

        if Microbes==1:
            plt.title("Microbes",fontsize=size_title)
        else:
            plt.title("Hosts",fontsize=size_title)
            
        sns.despine(\
            offset=0,ax=Hist_x,top=True,left=True,bottom=False)
        A=sns.distplot(X,bins=10,kde=False,norm_hist=True)
        plt.xlim(Lim_x_up[0], Lim_x_up[1])
        A.tick_params(axis='both',which='major',bottom='off',\
        top='off',labelbottom='off', left='off', labelleft='off')

        Lim_x_Hst=plt.gca().get_xlim()
        Lim_y_Hst=plt.gca().get_ylim()
        Hist_x.text(Lim_x_Hst[0]-0.1*(Lim_x_Hst[1]-Lim_x_Hst[0]),Lim_y_Hst[1] + 0.1*(Lim_y_Hst[1]-Lim_y_Hst[0]),letter, fontsize=size_letter,fontweight='bold')

    else:
        Scatter1.text(Lim_x_up[0]-0.1*(Lim_x_up[1]-Lim_x_up[0]),Lim_y_up[1] + 0.2*(Lim_y_up[1]-Lim_y_up[0]),letter, fontsize=size_letter,fontweight='bold')        
    #::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    
    #::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    Hist_y=plt.subplot(Frame[1, 1])
    Y = [y for y in Y if str(y) != 'nan']
    sns.despine(offset=0, ax=Hist_y,top=True,left=False,bottom=True)
    B=sns.distplot(Y,bins=10,vertical=True,kde=False, hist=True)
    plt.ylim(Lim_y_up[0], Lim_y_up[1])                               
    B.tick_params(axis='both',which='major',bottom='off',top='off',labelbottom='off', left='off', labelleft='off')          
    #::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
class Microbe:
    ...
    def top_membership(self, membership):
        self.top_membership=\
        self.membership.index(max(self.membership))
...
for Dataset in Datasets:
    ...
    for line_file in Results:
        ...
        for line in scores:
            ...
            if Number_of_Links==3:
                ...
                Total_scores_dict[ Pareja_Tupla ]=Bet
                #.......................................................
    ...
    Raw_Accuracy_Total, Raw_Precision_Total, Raw_Recall_Total=\
                Total_Validations(Confusion_Matrix_Raw_Total)
    ...
    #----------------------------------------------------------------
    Spearman_Patients_Recall=\
    stats.spearmanr(Patient_Entropies,Patient_Recalls)
    Spearman_Patients_Precision=\
    stats.spearmanr(Patient_Entropies,Patient_Precisions)
    Spearman_Patients_Accuracy=\
    stats.spearmanr(Patient_Entropies,Patient_Accuracies)
    Spearman_Patients_H_O_LogLikelihood=stats.spearmanr(\
    Patient_Entropies,Held_Out_LogLikelihood_Patients_Average)


    Spearman_Microbes_Recall=\
    stats.spearmanr(Microbe_Entropies,Microbe_Recalls)
    Spearman_Microbes_Precision=stats.spearmanr(\
    No_nan_Microbe_Entropies,No_nan_Microbe_Precisions)
    Spearman_Microbes_Accuracy=\
    stats.spearmanr(Microbe_Entropies,Microbe_Accuracies)
    Spearman_Microbes_H_O_LogLikelihood=stats.spearmanr(\
    Microbe_Entropies,Held_Out_LogLikelihood_Microbes_Average)
    #----------------------------------------------------------------
    #================================================================
    ...
    Patient_H_O_LogLikelihood_Datasets[Dataset]=\
        Held_Out_LogLikelihood_Patients_Average
    ...
    #----------------------------------------------------------------
    Spearman_Patients_Recall_Datasets[Dataset]=\
                        Spearman_Patients_Recall
    Spearman_Patients_Precision_Datasets[Dataset]=\
                       Spearman_Patients_Precision
    Spearman_Patients_Accuracy_Datasets[Dataset]=\
                      Spearman_Patients_Accuracy
    Spearman_Patients_H_O_LogLikelihood_Datasets[Dataset]=\
                    Spearman_Patients_H_O_LogLikelihood    
    #----------------------------------------------------------------
    ...
    Microbe_H_O_LogLikelihood_Datasets[Dataset]=\
        Held_Out_LogLikelihood_Microbes_Average
    ...
    #----------------------------------------------------------------
    Spearman_Microbes_Recall_Datasets[Dataset]=\
    Spearman_Microbes_Recall
    Spearman_Microbes_Precision_Datasets[Dataset]=\
    Spearman_Microbes_Precision
    Spearman_Microbes_Accuracy_Datasets[Dataset]=\
    Spearman_Microbes_Accuracy
    Spearman_Microbes_H_O_LogLikelihood_Datasets[Dataset]=\
    Spearman_Microbes_H_O_LogLikelihood    
    #----------------------------------------------------------------
...
#4.1. Distribute information in dictionaries
#====================================================================
Dataset2Plot='V-25_Tot' #'S-8_Tot', 'V-10_Tot', 'V-22_Tot', 'V-23_24_Tot', 'V-25_Tot'

Metrics_P={
'Precision': Patient_Precisions_Datasets[Dataset2Plot], 
'Recall': Patient_Recalls_Datasets[Dataset2Plot],
'Accuracy':Patient_Accuracies_Datasets[Dataset2Plot],
'Likelihood': Patient_H_O_LogLikelihood_Datasets[Dataset2Plot] }

Correlations_P={
'Precision': Spearman_Patients_Precision_Datasets[Dataset2Plot], 
'Recall': Spearman_Patients_Recall_Datasets[Dataset2Plot],
'Accuracy':Spearman_Patients_Accuracy_Datasets[Dataset2Plot],
'Likelihood': Spearman_Patients_H_O_LogLikelihood_Datasets[Dataset2Plot] }

Metrics_M={
'Precision': Microbe_Precisions_Datasets[Dataset2Plot], 
'Recall': Microbe_Recalls_Datasets[Dataset2Plot],
'Accuracy':Microbe_Accuracies_Datasets[Dataset2Plot],
'Likelihood': Microbe_H_O_LogLikelihood_Datasets[Dataset2Plot] }

Correlations_M={
'Precision': Spearman_Microbes_Precision_Datasets[Dataset2Plot], 
'Recall': Spearman_Microbes_Recall_Datasets[Dataset2Plot],
'Accuracy':Spearman_Microbes_Accuracy_Datasets[Dataset2Plot],
'Likelihood': Spearman_Microbes_H_O_LogLikelihood_Datasets[Dataset2Plot] }

#Metrics=['Precision', 'Recall', 'Accuracy', 'Likelihood']
Metrics=['Accuracy','Precision', 'Recall', 'Likelihood']
#====================================================================


#4.2. Fontsizes and Parameters
#===============
size_eje=11
size_ticks=9
size_title=15
...
#4.3. Define colors and shapes for plots
#====================================================================
...
for group in range(L/2):
    for shape in range(len(shapes)):
        colors_shapes_microbes[counter]=\
        (colors_microbes[group],shapes[shape])
...
#============================================
Letters={
'Accuracy': {'left':'a','right':'d'}, 
'Precision':    {'left':'b','right':'e'}, 
'Recall':  {'left':'c','right':'f'}, 
}
#============================================
...
gs.update(left=0.12,right=0.95,bottom=0.07,top=0.93,wspace=0.25,hspace=0.0)
#====================================================================
...
print Metrics
counter_plot=0
for Metric2Plot in Metrics[:-1]:

    #Left Column
    #::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    Plot_Patients= plt.subplot(gs[counter_plot, 0])

    #Joint_Plot
    #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    gs_subtest=gridspec.GridSpecFromSubplotSpec(2,2,\
    height_ratios=[0.5,1],width_ratios=[1, 0.15],\
    subplot_spec=gs[counter_plot,0] )

    Joint_Plot(Patient_Entropies_Datasets[Dataset2Plot],Metrics_P[Metric2Plot], Patient_top_memberships_Datasets[Dataset2Plot], gs_subtest, Metric2Plot, size_eje,Correlations_P[Metric2Plot],counter_plot,colors_patients,Letters[Metric2Plot]['left'])
    #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    Plot_Patients.text(Lim_x_up[0]-0.1*(Lim_x_up[1]-Lim_x_up[0]),Lim_y_up[1] + 0.1*(Lim_y_up[1]-Lim_y_up[0]),Letters[Metric2Plot]['left'], fontsize=size_letter,fontweight='bold')    
    #----------------------------------------------------------------
    ...
    #Right Column
    #::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    Plot_Microbes= plt.subplot(gs[counter_plot, 1])

    #Joint_Plot
    #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    gs_subtest_m=gridspec.GridSpecFromSubplotSpec(2,2,\
    height_ratios=[0.5,1],width_ratios=[1, 0.15],\
    subplot_spec=gs[counter_plot,1])

    Joint_Plot(Microbe_Entropies_Datasets[Dataset2Plot],Metrics_M[Metric2Plot],Microbe_top_memberships_Datasets[Dataset2Plot],gs_subtest_m, Metric2Plot,size_eje,Correlations_M[Metric2Plot],counter_plot,colors_shapes_microbes,Letters[Metric2Plot]['right'],True)
    #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    Plot_Microbes.text(Lim_x_dn[0]-0.1*(Lim_x_dn[1]-Lim_x_dn[0]), \
                       Lim_y_dn[1]+0.1*(Lim_y_dn[1]-Lim_y_dn[0]),\
                       Letters[Metric2Plot]['right'], \
                       fontsize=size_letter,fontweight='bold')    
    #----------------------------------------------------------------
...
plt.savefig(\
'../../Plots_Paper/Figure_S1_' + Dataset2Plot + '.pdf',dpi=300)
