...
int main(int argc, char *argv[])
{
  ...
  ModelParameters= \
  OutputPath + FoldNumber + "_" + "Seed_" + strSeed + "_K_" + strK + "_L_" + strL + "_Parameters_Test.txt";
  ...
  //=========================================================================
  string OutputFile;
  OutputFile= OutputPath + FoldNumber + "_" + "Seed_" + strSeed + "_" + "K_" + strK + "L_" + strL + "_scores_Test.txt";
